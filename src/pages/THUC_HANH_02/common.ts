/* ============================================================
 * THUC_HANH_01 — Common Utilities
 * Shared helper functions used by both Bài 1 (Game) and Bài 2 (Exam)
 * ============================================================ */
...
/** Export toàn bộ TH01 data từ localStorage ra object */
...
/** Import data từ object vào localStorage */
