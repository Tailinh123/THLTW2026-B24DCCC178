/* ============================================================
 * THUC_HANH_01 — Bài 2: Utility Functions
 * Exam generator algorithm, duplicate checker, export/import
 * ============================================================ */
import type {
  CauHoi,
  CauTrucDeThi,
...
/* =============================================================
 * 1. EXAM GENERATOR — Thuật toán tạo đề thi từ ma trận
 * ============================================================= */
...
/**
 * Tạo đề thi từ cấu trúc đề + ngân hàng câu hỏi.
 * Trả về danh sách câu hỏi ID nếu thành công, hoặc danh sách lỗi nếu thiếu câu.
 */
...
/**
 * Tính tổng câu + điểm + thời gian ước tính từ matran
 */
...
/* =============================================================
 * 2. DUPLICATE CHECKER — Kiểm tra trùng lặp giữa các đề thi
 * ============================================================= */
...
/**
 * So sánh 2 đề thi và trả về kết quả trùng lặp
 */
...
/* =============================================================
 * 3. EXPORT / IMPORT — Xuất / Nhập database JSON
 * ============================================================= */

/**
 * Tải xuống object dưới dạng file JSON
 */
...
/**
 * Đọc file JSON upload và trả về object
 */
